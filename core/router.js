...
// MÃÂÃÂ¡ÃÂÃÂ»ÃÂÃÂi module ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂng kÃÂÃÂÃÂÃÂ½ route cÃÂÃÂ¡ÃÂÃÂ»ÃÂÃÂ§a mÃÂÃÂÃÂÃÂ¬nh qua registerRoute()
...
export function initRouter() {
    ...
    navigate(); // render trang ÃÂÃÂÃÂÃÂÃÂÃÂ¡ÃÂÃÂºÃÂÃÂ§u tiÃÂÃÂÃÂÃÂªn
